...
As in \cite{Peng}, we consider vehicles with double-integrator dynamcis. In idealized double-integrator dynamics, the acceleration $a_i$ of the $i$th vehicle instantaneously takes on the value of the desired acceleration given by the control input $u_i$, resultin in the following dynamics:
