...
%TODO: Is it possible that the $f < a/2$-type conditions are sufficient but not necessary? Can't reverse the step where we square $|v|$...
...
%TODO: Caution function controllers are only more stable when b $\leq$ 2. But, when b>2, it's hard to make things unstable (without causing collisions first (clarify))
