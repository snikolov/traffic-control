...
\begin{gather}
u^2 + 2uvi - v^2 + au + avi - af\cos(\alpha_k) - afi\sin(\alpha_k) + af = 0
...
\Rightarrow a^2 - 4(af(1-\cos(\alpha_k))-v^2) < a^2\\
\Rightarrow - 4(af(1-\cos(\alpha_k))-v^2) < 0\\
\label{stbl3} \Rightarrow af(1-\cos(\alpha_k)) > v^2\\
\end{gather}
...
\Rightarrow \frac{f\sin(\alpha_k)}{v} - 1 < 0\\
\label{stbl4} \Rightarrow |v| > f\sin(\alpha_k)
\end{gather}
Combining (\ref{stbl3}) and (\ref{stbl4}), we have
\begin{gather}
af(1-\cos(\alpha_k)) > f^2\sin^2(\alpha_k)\\
\Rightarrow f < \frac{a(1-\cos(\alpha_k))}{\sin^2(\alpha_k)}\\
\Rightarrow f < \frac{a(1-\cos(\alpha_k))}{1-\cos^2(\alpha_k)}\\
\Rightarrow f < \frac{a(1-\cos(\alpha_k))}{(1+\cos2(\alpha_k))(1-\cos2(\alpha_k))}\\
\Rightarrow f < \frac{a}{2\cos^2(\frac{\alpha}{2})}
\end{gather}
